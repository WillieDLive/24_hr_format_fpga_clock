...
HD_PWD='C:/Users/Darrn/Documents/24_hr_format_fpga_clock/24_hr_clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGAClock_24hr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGAClock_24hr.tcl
