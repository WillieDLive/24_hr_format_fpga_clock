...
HD_PWD='C:/Users/Darrn/Documents/24_hr_format_fpga_clock/24_hr_clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGAClock_24hr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPGAClock_24hr.tcl -notrace
